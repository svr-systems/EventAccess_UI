      ...
      <div>
        <v-btn
          ...
          :to="{
            ...
            params: {
              presentation_dates: getEncodeId(item.id),
        ...
        >
          ...
          <v-tooltip activator="parent" location="bottom"
            >Ver tipos de boletos de presentación</v-tooltip
          >
        </v-btn>
        <v-btn
          v-if="item?.is_active"
        ...
        <v-col cols="12">
          <v-card>
            ...
            <v-card-text>
              <v-row dense>
                <v-col cols="12" md="4">
                  <VisVal label="Fecha de presentación" :value="item.date" />
                </v-col>

                <v-col cols="12" md="4">
                  <VisVal
                    label="Hora de recepción"
                    :value="item.reception_time"
                  />
                </v-col>
                ...
                <v-col cols="12" md="4">
                  <VisVal label="Hora de término" :value="item.end_time" />
                </v-col>
              </v-row>
            </v-card-text>
          </v-card>
...
const routeName = "presentation_dates";
